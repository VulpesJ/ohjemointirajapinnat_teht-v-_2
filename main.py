...
def new_department():
    with connect() as con:
        _departments = _get_departments(con)
        return render_template('departments/new.html', departments=_departments, error=None)
...
def add_department():
    ...
    with connect() as con:
        ...
        try:
            ...
            _departments = _get_departments(con)
            return render_template('departments/new.html', error=str(e), departments=_departments)
